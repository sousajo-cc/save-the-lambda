...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "28840bd6eec14faa4e48";
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _index = __webpack_require__(/*! ./index.css */ \"./src/components/app/index.css\");\n\nvar css = _interopRequireWildcard(_index);\n\nvar _loaders = __webpack_require__(/*! ./loaders.js */ \"./src/components/app/loaders.js\");\n\nvar _map = __webpack_require__(/*! ./map.js */ \"./src/components/app/map.js\");\n\nvar _keyState = __webpack_require__(/*! ./keyState.js */ \"./src/components/app/keyState.js\");\n\nvar _keyState2 = _interopRequireDefault(_keyState);\n\nvar _hero = __webpack_require__(/*! ./hero.js */ \"./src/components/app/hero.js\");\n\nvar _hero2 = _interopRequireDefault(_hero);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar App = function () {\n  function App(elem) {\n    _classCallCheck(this, App);\n\n    if (!elem) return;\n    this.elem = elem;\n  }\n\n  _createClass(App, [{\n    key: 'render',\n    value: function render() {\n      var canvas = document.getElementById('game');\n      var context = canvas.getContext('2d');\n\n      // TODO: \n      // get rid of this promise hell\n      // use this instead:\n      // Promise.all([promise1, promise2, promise3]).then((values) => {\n      //  console.log(values);\n      //});\n      (0, _loaders.loadMapSprites)().then(function (sprites) {\n        (0, _loaders.loadNpcSprites)().then(function (npcSprites) {\n          (0, _map.drawMap)(sprites, npcSprites, context); // draw this to buffer to draw onluy once\n          (0, _loaders.loadHeroSprite)().then(function (heroSprite) {\n            var input = new _keyState2.default();\n            var hero = new _hero2.default();\n\n            hero.draw = function drawHero(context) {\n              heroSprite.draw('start_pos', context, this.x, this.y);\n            };\n\n            // TODO: this does nothing\n            hero.updatePosition = function updateHeroPos(dir) {\n              this.move(dir);\n            };\n\n            window.addEventListener('keydown', function (event) {\n              var dir = input.useKeyPressed(event);\n              if (dir) {\n                hero.updatePosition(dir);\n              }\n            });\n\n            function updatePos() {\n              (0, _loaders.loadMapSprites)().then(function (sprites) {\n                (0, _loaders.loadNpcSprites)().then(function (npcSprites) {\n                  (0, _map.drawMap)(sprites, npcSprites, context);\n                });\n              });\n              hero.draw(context);\n              requestAnimationFrame(updatePos);\n            }\n            updatePos();\n          });\n        });\n      });\n    }\n  }]);\n\n  return App;\n}();\n\nexports.default = App;\n\n//# sourceURL=webpack:///./src/components/app/index.js?");

/***/ }),

/***/ "./src/components/app/keyState.js":
/*!****************************************!*\
  !*** ./src/components/app/keyState.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n\tvalue: true\n});\nexports.loadImg = loadImg;\nexports.loadMapSprites = loadMapSprites;\nexports.loadNpcSprites = loadNpcSprites;\nexports.loadHeroSprite = loadHeroSprite;\n\nvar _spritesheet = __webpack_require__(/*! ./spritesheet.js */ \"./src/components/app/spritesheet.js\");\n\nvar _spritesheet2 = _interopRequireDefault(_spritesheet);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction loadImg(url) {\n\treturn new Promise(function (resolve) {\n\t\tvar image = new Image();\n\t\timage.addEventListener('load', function () {\n\t\t\tresolve(image);\n\t\t});\n\t\timage.src = url;\n\t});\n}\n\nfunction loadMapSprites() {\n\treturn loadImg('img/tiles.png').then(function (img) {\n\t\tvar sprites = new _spritesheet2.default(img, 70, 70);\n\t\tsprites.define('yellow_exclamation_block', 0, 0);\n\t\tsprites.define('brown_exclamation_block', 0, 1);\n\t\t// TODO:\n\t\t// these weirds offsets are because of the spaces of the tileset\n\t\t// find a way to handle this\n\t\tsprites.define('win', 1 + 0.04, 8 + 0.10);\n\t\treturn sprites;\n\t});\n}\n\nfunction loadNpcSprites() {\n\treturn loadImg('img/npc.png').then(function (img) {\n\t\tvar sprites = new _spritesheet2.default(img, 65, 90);\n\t\tsprites.define('npc', 0, 0);\n\t\treturn sprites;\n\t});\n}\n\nfunction loadHeroSprite() {\n\treturn loadImg('img/p1_walk.png').then(function (img) {\n\t\tvar sprites = new _spritesheet2.default(img, 65, 70);\n\t\tsprites.define('start_pos', 0, 0);\n\t\treturn sprites;\n\t});\n}\n\n//# sourceURL=webpack:///./src/components/app/loaders.js?");

/***/ }),

/***/ "./src/components/app/map.js":
/*!***********************************!*\
  !*** ./src/components/app/map.js ***!
  \***********************************/
/*! no static exports found */
